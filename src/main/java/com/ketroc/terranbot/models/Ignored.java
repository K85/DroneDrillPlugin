...
public abstract class Ignored {
    ...
    public static boolean contains(Tag unitToCheck) {
        return ignoredUnits.stream().anyMatch((ignoredUnit) -> {
            return ignoredUnit.unitTag.equals(unitToCheck);
        });
    }
    ...
    public static void onStep() {
        ignoredUnits.removeIf((ignoredUnit) -> {
            return ignoredUnit.doReleaseUnit();
        });
    }
