...
public class Chat {
    public static final List<String> VIKING_DIVE;
    ...
    static {
        ...
        VIKING_DIVE = new ArrayList(List.of("Vikings, YOLO!", "Time to sacrifice vikings to the Gods of Aiur", "Vikings, do your thing", "Let's purge some tempests", "Stalkers, please don't look up so I can kill some tempests"));
    }
